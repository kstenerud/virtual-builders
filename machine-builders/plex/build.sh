...
Note: mounts (-m) are specified in the format 'host_path:name' where:
    ...
    name = name of the directory to mount in the guest under /mnt (so that it will be mounted as /mnt/name)."
options_add_switch m number "Mount a media directory" required
